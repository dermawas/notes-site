...
date: 2026-01-01 00:00:00 +07:00
categories:
  - notes
tags:
  - freelance
...
- **Non-solicitation** — reduced from 12 months to 9, with an explicit carve-out: extensions for hypercare or warranty do not reset the clock
...
Some of these feel small on paper. The portfolio clause in particular — many contractors don't think to ask for it, then find themselves unable to reference a significant project in their professional history because the confidentiality provisions are broad enough to prohibit it. It's worth asking for explicitly.
...
The pay-when-paid structure, even with the safeguard, has a structural gap that I haven't fully resolved.
...
I'm not raising this as a warning about the vendor — the negotiation throughout was conducted in good faith and the responses were consistently direct and commercially reasonable. I'm raising it because it's the kind of question that's easy to miss when you're focused on the obvious clauses — compensation, termination, IP — and it's worth thinking about before you're the only face visible to a large domestic client on behalf of a foreign entity with no local registration.

---

## What I Would Tell Another Freelancer

A few things I'd pass on to someone in a similar position.
...
**The allowance negotiation is about arithmetic, not principle.** Don't frame it as fairness — frame it as actual cost. I put together the real numbers: commute cost per day, monthly accommodation near the worksite, the gap between what was offered and what the arrangement would actually cost to operate. That framing worked better than a general request for more.
...
**The authority matrix is your protection, not theirs.** Defining what you can decide independently and what requires written approval before you communicate it to the client means that when the client asks you something that's outside your scope, you have a documented reason to say *let me come back to you*. Without it, you're making judgment calls in the room with no cover.
...
*Written after the engagement concluded. All parties, projects, and commercial terms are anonymized. This article reflects my personal experience and analysis only.*
